...
// Determines whether the first code point of the provided string is within a
// range that contains emoji. Some of the codepoints in these ranges are
// unassigned so this test is an approximation to the real thing.
// Ranges taken from:
